...
// Mock data
const mockLocation: location = [51.5068495, -0.0754049]
...
describe('makeSearchUrl', () => {
  it('should create the correct URL for the given latitude and longitude', () => {
    const url = makeSearchUrl(mockLocation[0], mockLocation[1])
    expect(url).toBe(
      `https://maps.googleapis.com/maps/api/js/GeoPhotoService.SingleImageSearch?pb=!1m5!1sapiv3!5sUS!11m2!1m1!1b0!2m4!1m2!3d${mockLocation[0]}!4d${mockLocation[1]}!2d50!3m10!2m2!1sen!2sGB!9m1!1e2!11m4!1m3!1e2!2b1!3e2!4m10!1e1!1e2!1e3!1e4!1e8!1e6!5m1!1e2!6m1!1e2&callback=callbackfunc`,
    )
  })
})
...
describe('searchPanorama', () => {
  ...
  it('should return the panorama for the given location', async () => {
    ...
    const panorama = await searchPanorama(session, ...mockLocation)
  ...
  it('should return an empty array when no panorama is found', async () => {
    ...
    const panorama = await searchPanorama(session, mockLocation[0], mockLocation[1])
